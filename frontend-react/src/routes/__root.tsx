  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "SeaBorg — Ocean Intelligence" },
      {
        ...
        content:
          "AI-native interface for global ocean data. Ask questions, get charts, see the SQL.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Outfit:wght@400;500;600;700&family=Inter:wght@400;500;600&family=JetBrains+Mono:wght@400;500;600&display=swap",
      },
    ],
  }),
